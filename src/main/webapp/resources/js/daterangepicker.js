  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function(options, callback) {
            ...
            this.locale = {
                applyLabel: $("#applyMessage").val(),
                cancelLabel: $("#cancelMessage").val(),
                fromLabel: 'From',
                toLabel: 'To',
                weekLabel: 'W',
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (this.timePicker) {
                ...
                if (this.timePicker12Hour) {
                    ...
                    var pm_msg=$("#pmMessage").val();
                    var am_msg=$("#amMessage").val();
                    ...
                    if (selected.hour() >= 12) {
                        html += '<option value="AM"' + am_html + 'label='+am_msg+'></option><option value="PM" selected="selected"' + pm_html + 'label='+pm_msg+'></option>';
                    } else {
                        html += '<option value="AM" selected="selected"' + am_html + 'label='+am_msg+'></option><option value="PM"' + pm_html + 'label='+pm_msg+'></option>';
                    }
                    html += '</select>';
                }
