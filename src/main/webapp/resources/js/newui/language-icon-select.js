...
IconSelect.COMPONENT_ICON_FILE_PATH = "../resources/images/i18n/arrow.png";
...
function IconSelect($$elementID, $$parameters) {
    ...
    this.refresh = function($icons){
        ...
        for(var i = 0; i < $icons.length; i++){
            $icons[i].element = _View.createIcon($icons[i].iconFilePath, $icons[i].iconValue, i, $$parameters,$icons[i].alt,$icons[i].title);
    ...
    this.setSelectedIndex = function($index){
        ...
        if(icon){
            ...
            _View.selectedIconImgElement.setAttribute('alt', icon.alt);
            _View.selectedIconImgElement.setAttribute('title', icon.title);
    ...
    this.getSelectedAlt = function(){return _icons[_selectedIndex].alt};
    this.getSelectedTitle = function(){return _icons[_selectedIndex].title};
    ...
    _View.createUI = function($parameters){
        ...
        */
        ...
        labelElement.setAttribute('id','selectedLabel');
        
        
        selectedIconElement.appendChild(labelElement);
    ...
    _View.createIcon = function($iconFilePath, $iconValue, $index, $parameters,$alt,$title){
        ...
        iconImgElement.setAttribute('alt', $alt);
        iconImgElement.setAttribute('title', $title);
       
        
        //23-1-2017
        
        var labelElement = document.createElement('label');
        labelElement.setAttribute('id','label'+$index);
        labelElement.setAttribute('class','langlabel');
