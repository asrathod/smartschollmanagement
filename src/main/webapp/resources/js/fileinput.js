...
(function (factory) {
    ...
    defaultPreviewSettings = {
        image: {width: "90px", height: "80px"},
        html: {width: "90px", height: "80px"},
        text: {width: "90px", height: "80px"},
        video: {width: "90px", height: "80px"},
        audio: {width: "90px", height: "80px"},
        flash: {width: "90px", height: "80px"},
        object: {width: "90px", height: "80px"},
        other: {width: "90px", height: "80px"}
    };
